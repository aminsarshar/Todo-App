...
>
    <div class="flex justify-between border-b border-b-gray-300 p-4 bg-gray-100">
        <span class="font-bold text-xl">Create Category</span>
        <a
    ...
    <form class="m-5" action="{{route('category.store')}}" method="POST">
        @csrf
        <div>Title</div>
        <input name="title" type="text" class="input-create w-full h-9 border border-gray-200 rounded-md focus-visible:outline-gray-300 pl-2"/>
