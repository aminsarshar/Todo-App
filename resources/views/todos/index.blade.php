...
@section('content')
    <div class="rounded-xl border border-gray-300 relative overflow-x-auto w-[80%] my-10 mx-auto">
        <div class="flex justify-between border-b border-b-gray-300 p-4 bg-gray-100 dark:bg-gray-800">
            <a href="{{ route('todo.create') }}"
                class="rounded-sm bg-gray-800 dark:bg-slate-300 hover:bg-gray-400 transition-all text-white dark:text-gray-900 w-22 text-center h-8">create</a>
            <span class="text-white dark:text-slate-300 font-bold text-xl">ToDo</span>
        </div>
